...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  Wi() {
    var _a;
    "function" == typeof ((_a = this.window) == null ? void 0 : _a.addEventListener) && (this.xi = () => {
      this.ss();
  ...
  rs(e) {
    var _a;
    try {
      const t = null !== ((_a = this.Ki) == null ? void 0 : _a.getItem(this.ns(e)));
  ...
  constructor(e, t) {
    ...
    this.Uu().then((e2) => {
      e2 && e2.Qa() ? this.metadata.resolve(e2.Wa.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(e2 == null ? void 0 : e2.Wa)}`));
...
var __PRIVATE_BundleReaderSyncImpl = class {
  constructor(e, t) {
    ...
    if (!n || !n.Qa()) throw new Error(`The first element of the bundle is not a metadata object, it is
         ${JSON.stringify(n == null ? void 0 : n.Wa)}`);
    this.metadata = n;
    do {
